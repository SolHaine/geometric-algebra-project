...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of c2ga.


// Anti-doublon
#ifndef C2GA_MULTI_VECTOR_HPP__
#define C2GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "c2ga/Geometric.hpp"

#include "c2ga/OuterExplicit.hpp"
#include "c2ga/InnerExplicit.hpp"
#include "c2ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e0() const {return this->extractOneComponent(1,4, 0);}
        Mvec e1() const {return this->extractOneComponent(1,4, 1);}
        Mvec e2() const {return this->extractOneComponent(1,4, 2);}
        Mvec ei() const {return this->extractOneComponent(1,4, 3);}
        Mvec e01() const {return this->extractOneComponent(2,6, 0);}
        Mvec e02() const {return this->extractOneComponent(2,6, 1);}
        Mvec e0i() const {return this->extractOneComponent(2,6, 2);}
        Mvec e12() const {return this->extractOneComponent(2,6, 3);}
        Mvec e1i() const {return this->extractOneComponent(2,6, 4);}
        Mvec e2i() const {return this->extractOneComponent(2,6, 5);}
        Mvec e012() const {return this->extractOneComponent(3,4, 0);}
        Mvec e01i() const {return this->extractOneComponent(3,4, 1);}
        Mvec e02i() const {return this->extractOneComponent(3,4, 2);}
        Mvec e12i() const {return this->extractOneComponent(3,4, 3);}
        Mvec e012i() const {return this->extractOneComponent(4,1, 0);}
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[15] = pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 0.
    template<typename T>
    static Mvec<T> e0(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector i.
    template<typename T>
    static Mvec<T> ei(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 0i.
    template<typename T>
    static Mvec<T> e0i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 1i.
    template<typename T>
    static Mvec<T> e1i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 2i.
    template<typename T>
    static Mvec<T> e2i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 01i.
    template<typename T>
    static Mvec<T> e01i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 02i.
    template<typename T>
    static Mvec<T> e02i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 12i.
    template<typename T>
    static Mvec<T> e12i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 012i.
    template<typename T>
    static Mvec<T> e012i(){
        Mvec<T> res;
