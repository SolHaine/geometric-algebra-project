...
/// \brief Explicit precomputed per grades geometric products of p2ga.


#ifndef P2GA_GEOMETRIC_PRODUCT_EXPLICIT_HPP__
#define P2GA_GEOMETRIC_PRODUCT_EXPLICIT_HPP__
#pragma once
...
#endif // P2GA_GEOMETRIC_PRODUCT_EXPLICIT_HPP__