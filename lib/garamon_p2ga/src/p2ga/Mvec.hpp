...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of p2ga.


// Anti-doublon
#ifndef P2GA_MULTI_VECTOR_HPP__
#define P2GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "p2ga/Constants.hpp"

#include "p2ga/Outer.hpp"
#include "p2ga/Inner.hpp"
#include "p2ga/Geometric.hpp"

#include "p2ga/OuterExplicit.hpp"
#include "p2ga/InnerExplicit.hpp"
#include "p2ga/GeometricExplicit.hpp"
...
namespace p2ga{
    ...
    public:
        ...
        /* the metric defined in this algebra is not full ranked, so the following fuction can not be implemented
...
*/
        ...
        Mvec e0() const {return this->extractOneComponent(1,3, 0);}
        Mvec e1() const {return this->extractOneComponent(1,3, 1);}
        Mvec e2() const {return this->extractOneComponent(1,3, 2);}
        Mvec e01() const {return this->extractOneComponent(2,3, 0);}
        Mvec e02() const {return this->extractOneComponent(2,3, 1);}
        Mvec e12() const {return this->extractOneComponent(2,3, 2);}
        Mvec e012() const {return this->extractOneComponent(3,1, 0);}
    ...
    */
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[7] = pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
    */
