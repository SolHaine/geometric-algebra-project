...
Garamon (Geometric Algebra Recursive and Adaptative Monster) is C++ library dedicated for p2ga Geometric Algebra.
...
## Install for Linux-Mac from the terminal
    ...
    * you can find a sample code dedicated to p2ga in the 'sample directory'
